...
const Departments = () => (
    <section id="departments" className="min-h-screen bg-black text-white flex flex-col justify-center p-8">
        <div className="container mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {['CSE', 'ECE', 'EEE', 'ME', 'CE', 'CHE', 'IT', 'AI'].map((dept) => (
                    <div key={dept} className="h-32 flex items-center justify-center border border-white/10 hover:bg-ajce-gold hover:text-black transition-all cursor-pointer">
