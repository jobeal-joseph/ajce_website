...
const Contact = () => (
    <section id="contact" className="min-h-screen bg-ajce-dark text-white flex flex-col justify-center p-8 border-t border-white/10">
        <div className="container mx-auto text-center">
            ...
            <button className="px-12 py-4 bg-white text-black font-serif text-lg hover:bg-ajce-gold transition-colors">
                Apply Now
            </button>
        </div>
    </section>
